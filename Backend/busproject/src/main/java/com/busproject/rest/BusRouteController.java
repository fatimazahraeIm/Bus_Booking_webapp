...
import com.busproject.service.BusRouteService;
...
public class BusRouteController {
    ...
    public List<LocalTime> getAllSlots(){
    	return busRouteService.getAllHoraires();
    }
    //RETRIEVE FUNCTION FOR FARE ID
    @GetMapping(value="/route/fare/{fareID}", produces="application/json")
    public RoutePrice getRouteFareByRouteFareId(@PathVariable int fareID) {
    	return busRouteService.getRoutePrice(fareID);
    }
